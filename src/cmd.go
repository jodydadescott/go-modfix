...
func Run() {
	...
	command.PersistentFlags().BoolVarP(&verboseArg, "verbose", "v", false, "Enables verbose output")
	command.PersistentFlags().BoolVarP(&dryRunArg, "dry-run", "d", false, "Enables dry run (no changes will be made)")
